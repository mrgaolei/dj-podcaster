...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feed.display_num'
        db.add_column(u'podcast_feed', 'display_num',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Feed.display_num'
        db.delete_column(u'podcast_feed', 'display_num')
    ...
    models = {
        ...
        u'podcast.feed': {
            ...
            'display_num': ('django.db.models.fields.SmallIntegerField', [], {'default': '100'}),
        ...
        u'podcast.podcast': {
            ...
            'pubdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 21, 0, 0)'}),
